...
Предварительно прописаны сервисы типа NodePort и сами адреса портов, они должны совпадать с тем, что определяется в манифесте самого балансера.
...
Проверка состояния целевых групп периодически может сигналить об ошибках доступности какой то из нод, на работу балансировщика в общем случае это не влияет.  
