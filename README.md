...
Отсюда нужны именно внутренние адресы а не внешние, расскоментируем манифест балансера, впишем туда внутренние адреса тачек и применим тераформ манифест.
